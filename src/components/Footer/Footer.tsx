    ...
    <footer className="app-footer">
      <div className="footer-content">
        ...
        <div className="footer-section brand-section">
          ...
          <p className="footer-description">
            Plataforma de videollamadas y reuniones en línea segura y confiable. 
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            {user ? (
             ...
             <li>
              <Link to="/about-us" className={isActive('/about-us')}>Sobre Nosotros</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            <li>
              <Link to="/privacy-policy" className={isActive('/privacy-policy')}>
                Política de Privacidad
              </Link>
            </li>
            <li>
              <Link to="/data-deletion" className={isActive('/data-deletion')}>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            <li>
              <a href="mailto:support@teamlink.com">Contacto</a>
            </li>
            {!user && (
              <li>
                <Link to="/forgot-password" className={isActive('/forgot-password')}>
      ...
      <div className="footer-bottom">
        <p className="footer-copyright">
          © {currentYear} TeamLink. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
